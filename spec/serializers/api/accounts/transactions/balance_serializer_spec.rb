...
RSpec.describe API::Accounts::Transactions::BalanceSerializer do
  describe "#key" do
  ...
  describe "#balance" do
    ...
    before { create_list(:transaction_entry, 10, account: account) }
  ...
  describe "#balance_prior_to" do
    ...
    let!(:cleared_transactions) do
      create_list(:transaction_entry, 10, account: account, clearance_date: clearance_date)
    end
