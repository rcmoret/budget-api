...
const BudgetedSuggestion = () => {
  ...
  const { flags } = event;
  const isSelected =
    "default" !== selectedSuggestion && event.flags.eqPrevBudgeted;

  const label = flags.eqPrevSpent ? "Budgeted / Spent" : "Budgeted";
...
const DefaultSuggestion = () => {
  ...
  if (defaultAmount === 0 && !showEditForm) {
    ...
    return <DefaultAmountForm toggleEditForm={toggleEditForm} />;
  }
};
