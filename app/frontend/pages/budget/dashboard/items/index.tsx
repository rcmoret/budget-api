import {
  ...
  useBudgetItemGroups as getBudgetItemGroup,
  ItemGroup,
...
const clearedItemFilter = (props: {
  item: BudgetItem;
  showClearedItems: boolean;
}) => {
...
const FilteredItemsDetail = (props: {
